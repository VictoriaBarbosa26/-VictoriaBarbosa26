...
<div style="display: flex; align-items: center;">
  <img src="(https://github.com/VictoriaBarbosa26/-VictoriaBarbosa26/blob/main/fundo.jpg?raw=true)" alt="Imagem" width="150" style="margin-right: 20px; border-radius: 8px;"/>
  <div>
    <p><b>Principal:</b></p>
